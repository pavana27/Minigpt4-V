...
from minigpt4.datasets.datasets.video_datasets import CMDVideoDataset, WebVidDataset,VideoChatGPTDataset, EngageNetDataset, DaiseeDataset,SedDataset, UbfcDataset
...
class EngageNetBuilder(BaseDatasetBuilder):
    ...
    DATASET_CONFIG_DICT = {
        "default": "/home/pavana/MiniGPT4-video/minigpt4/configs/datasets/engagenet/default.yaml",
    }
    logger.info(DATASET_CONFIG_DICT)
...
class DaiseeBuilder(BaseDatasetBuilder):
    ...
    DATASET_CONFIG_DICT = {
        "default": "/home/pavana/MiniGPT4-video/minigpt4/configs/datasets/daisee/default.yaml",
    }
    logger.info(DATASET_CONFIG_DICT)
...
@registry.register_builder("sed")
class SedBuilder(BaseDatasetBuilder):
    train_dataset_cls = SedDataset # Add the dataset class here
    val_dataset_cls = SedDataset

    DATASET_CONFIG_DICT = {
        "default": "/home/pavana/MiniGPT4-video/minigpt4/configs/datasets/sed/default.yaml",
    }
    logger.info(DATASET_CONFIG_DICT)
...
@registry.register_builder("ubfc_phys")
class UbfcPhysBuilder(BaseDatasetBuilder):
    train_dataset_cls = UbfcDataset # Add the dataset class here
    val_dataset_cls = UbfcDataset

    DATASET_CONFIG_DICT = {
        "default": "/home/pavana/MiniGPT4-video/minigpt4/configs/datasets/ubfc_phys/default.yaml",
    }
    logger.info(DATASET_CONFIG_DICT)
